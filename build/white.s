...
@
@	Time-stamp: 2023-04-05, 15:53:59
...
@=======================================================================
	...
	.section .rodata
	.align	2
	.global whiteTiles		@ 128 unsigned chars
	.hidden whiteTiles
whiteTiles:
	...
	.section .rodata
	.align	2
	.global whitePal		@ 512 unsigned chars
	.hidden whitePal
whitePal:
	.hword 0x0000,0x0000,0x0200,0x0210,0x4000,0x4010,0x4200,0x6318
